...
static yyconst short int yy_base[25] =
    {   0,
        0,    0,    2,    0,    5,    0,   17,    0,   21,   23,
       18,   17,   23,    0,   23,   16,   23,    7,    0,   23,
       10,   12,   14,    0
    } ;

static yyconst short int yy_def[25] =
    {   0,
       21,   21,   21,    3,   21,    5,    5,    7,   20,   20,
       22,   23,   20,   24,   20,   22,   20,   23,   24,    0,
       20,   20,   20,   20
    } ;

static yyconst short int yy_nxt[29] =
    {   0,
       20,   20,   19,   11,   11,   12,   12,   13,   17,   14,
       10,   10,   10,   16,   16,   18,   18,   15,   17,   15,
       20,   10,    9,   20,   20,   20,   20,   20
    } ;

static yyconst short int yy_chk[29] =
    {   0,
        0,    0,   24,    2,    2,    3,    3,    5,   18,    5,
       21,   21,   21,   22,   22,   23,   23,   16,   12,   11,
...
char *yytext;
#line 1 "decimate-sparse.ll"
#define INITIAL 0
/*-*- c++ -*-*/
#line 4 "decimate-sparse.ll"
#include <iostream>
...
#line 30 "decimate-sparse.ll"



#line 557 "decimate-sparse.cc"
...
case 5:
YY_RULE_SETUP
#line 68 "decimate-sparse.ll"
ECHO;
	YY_BREAK
#line 692 "decimate-sparse.cc"
case YY_STATE_EOF(INITIAL):
case YY_STATE_EOF(SITE):
case YY_STATE_EOF(COUNTS):
case YY_STATE_EOF(EXEMPT):
	yyterminate();
